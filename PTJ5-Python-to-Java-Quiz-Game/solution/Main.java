...
public class Main {
    ...
    private static final String CLASS_KEYWORD_QUESTION =
        "What keyword defines a class in Java? ";
    private static final String STRING_COMPARE_QUESTION =
	 ...
	 */
    private static int askQuestion(Scanner scanner, String prompt,
    ...
    public static void main(String[] args) {
        ...
        score +=
            askQuestion(scanner, CLASS_KEYWORD_QUESTION, CLASS_KEYWORD_ANSWER);
        score += askQuestion(scanner, STRING_COMPARE_QUESTION,
                             STRING_COMPARE_ANSWER);
