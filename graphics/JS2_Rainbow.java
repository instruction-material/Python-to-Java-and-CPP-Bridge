...
public class JS2_Rainbow extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        root.getChildren().addAll(redArc, orangeArc, yellowArc, greenArc,
                                  blueArc, magentaArc);
    ...
    private Arc createColoredArc(int x, int y, int width, int height,
                                 Color color) {
        Arc arc = new Arc(x + width / 2.0, y + height / 2.0, width / 2.0,
                          height / 2.0, 0, 180);
